...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, LD2_Pin|COOLER_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, HUMIDIFICADOR_Pin|LUZ_Pin|MOTOR_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : HUMIDIFICADOR_Pin LUZ_Pin MOTOR_Pin */
  GPIO_InitStruct.Pin = HUMIDIFICADOR_Pin|LUZ_Pin|MOTOR_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
