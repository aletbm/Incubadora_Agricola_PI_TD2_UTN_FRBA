...
{
	HAL_GPIO_WritePin(GPIOB, humidificador_Pin, GPIO_PIN_SET);
	HAL_GPIO_WritePin(GPIOB, buzzer_Pin, GPIO_PIN_SET);
	HAL_GPIO_WritePin(GPIOB, lampara_Pin, GPIO_PIN_SET);
...
{
    HAL_GPIO_WritePin(GPIOB, buzzer_Pin, RELE_ACTIVO);
    buzzer_estado = 1;
}
void apagar_buzzer(void)
{
    HAL_GPIO_WritePin(GPIOB, buzzer_Pin, RELE_INACTIVO);
    buzzer_estado = 0;
}
...
{
    HAL_GPIO_WritePin(GPIOB, humidificador_Pin, RELE_ACTIVO);
    humidificador_estado = 1;
}
void apagar_humidificador(void)
{
    HAL_GPIO_WritePin(GPIOB, humidificador_Pin, RELE_INACTIVO);
    humidificador_estado = 0;
}
...
{
    HAL_GPIO_WritePin(GPIOB, lampara_Pin, RELE_ACTIVO);
    lampara_estado = 1;
}
void apagar_lampara(void)
{
    HAL_GPIO_WritePin(GPIOB, lampara_Pin, RELE_INACTIVO);
    lampara_estado = 0;
}
...
{
    HAL_GPIO_WritePin(GPIOB, cooler_Pin, RELE_ACTIVO);
    cooler_estado = 1;
}

void apagar_cooler(void)
{
    HAL_GPIO_WritePin(GPIOB, cooler_Pin, RELE_INACTIVO);
    cooler_estado = 0;
}
